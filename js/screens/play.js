game.PlayScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        me.input.bindKey(me.input.KEY.B, "fly", true);
        me.input.bindKey(me.input.KEY.F, "fly", true);
        game.data.score = 0;
        game.data.steps = 0;
        ...
        //inputs
        me.input.bindPointer(me.input.pointer.LEFT, me.input.KEY.B, me.input.KEY.F);
